...
export const marketplaceCopy = {
  en: {
    ...
    jobForm: {
      ...
      contactMethodLabel: "How should artisans contact you?",
      contactWhatsapp: "WhatsApp",
      contactWhatsappHint: "Fastest — artisans message you directly",
      contactCall: "Call / SMS",
      contactCallHint: "No WhatsApp needed — artisans phone you",
  ...
  fr: {
    ...
    jobForm: {
      ...
      contactMethodLabel: "Comment les artisans doivent-ils vous contacter ?",
      contactWhatsapp: "WhatsApp",
      contactWhatsappHint: "Le plus rapide — les artisans vous ecrivent directement",
      contactCall: "Appel / SMS",
      contactCallHint: "Pas besoin de WhatsApp — les artisans vous appellent",
  ...
  mfe: {
    ...
    jobForm: {
      ...
      contactMethodLabel: "Kouma bann artizan bizin kontakte ou?",
      contactWhatsapp: "WhatsApp",
      contactWhatsappHint: "Pli vit — artizan ekrir ou direk",
      contactCall: "Apel / SMS",
      contactCallHint: "Pa bizin WhatsApp — artizan telefonn ou",
