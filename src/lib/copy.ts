...
export const marketplaceCopy = {
  en: {
    ...
    jobForm: {
      ...
      urgentTitle: "I need help today",
      urgentDesc: "Urgent matching for same-day problems.",
      plannedTitle: "I'm planning ahead",
      plannedDesc: "Post it and let verified artisans reply.",
      describeLabel: "Describe the problem in your own words",
      describePlaceholder: "The kitchen tap is leaking, the power keeps tripping, the door is stuck...",
      tradeLabel: "Trade - tap to change",
      ...
      locDenied: "Location denied. No problem, pick the closest area.",
      whatsappLabel: "WhatsApp number",
      privacy: "Your number is never shown directly. Artisans contact you only through the app or a protected link.",
      addPhoto: "Add a photo",
      photoHint: "Optional, image under 5 MB",
      errUrgency: "Choose how soon you need help.",
      errDescription: "Add at least 10 characters so artisans understand the job.",
      errDistrict: "Choose the closest area.",
      errPhone: "Enter a valid Mauritius WhatsApp number.",
      errPhotoType: "Please choose an image file.",
      errPhotoSize: "Photo is too large. Please choose an image under 5 MB.",
      errPost: "Request could not be posted.",
      errFailed: "Request failed. Try again.",
      back: "Back",
      continue: "Continue",
      submitUrgent: "Find artisans now",
      submitPlanned: "Post my request",
      reqPrefix: "Request",
      confTitle: "Your request is live",
      confNotifying: (n: number, d: string) => `Notifying ${n} registered artisans matched to ${d} now`,
    ...
    dashboard: {
      ...
      claimedJobsDesc: "Jobs you have accepted. Release if you can't complete one.",
      targetedLeadsTitle: "Targeted leads",
      jobBoardTitle: "Job board — all open jobs",
  ...
  fr: {
    ...
    jobForm: {
      ...
      urgentTitle: "J'ai besoin d'aide aujourd'hui",
      urgentDesc: "Mise en relation urgente pour le jour meme.",
      plannedTitle: "Je planifie a l'avance",
      plannedDesc: "Postez et laissez les artisans verifies repondre.",
      describeLabel: "Decrivez le probleme avec vos mots",
      describePlaceholder: "Le robinet de la cuisine fuit, le courant saute, la porte est bloquee...",
      tradeLabel: "Metier - touchez pour changer",
      ...
      locDenied: "Position refusee. Pas de souci, choisissez la region la plus proche.",
      whatsappLabel: "Numero WhatsApp",
      privacy: "Votre numero n'est jamais montre directement. Les artisans vous contactent via l'app ou un lien protege.",
      addPhoto: "Ajouter une photo",
      photoHint: "Optionnel, image de moins de 5 Mo",
      errUrgency: "Choisissez quand vous avez besoin d'aide.",
      errDescription: "Ajoutez au moins 10 caracteres pour que les artisans comprennent le travail.",
      errDistrict: "Choisissez la region la plus proche.",
      errPhone: "Entrez un numero WhatsApp mauricien valide.",
      errPhotoType: "Veuillez choisir un fichier image.",
      errPhotoSize: "Photo trop lourde. Choisissez une image de moins de 5 Mo.",
      errPost: "La demande n'a pas pu etre postee.",
      errFailed: "Echec de la demande. Reessayez.",
      back: "Retour",
      continue: "Continuer",
      submitUrgent: "Trouver des artisans",
      submitPlanned: "Poster ma demande",
      reqPrefix: "Demande",
      confTitle: "Votre demande est en ligne",
      confNotifying: (n: number, d: string) => `Nous prevenons ${n} artisans enregistres pour ${d}`,
      confTargeted: "artisans cibles",
      confResponse: "temps de reponse moyen",
      confAccept: "Nous vous enverrons un message quand un artisan accepte",
    ...
    dashboard: {
      ...
      claimedJobsDesc: "Travaux que vous avez acceptes. Liberez-en un si vous ne pouvez pas le faire.",
      targetedLeadsTitle: "Demandes ciblees",
      jobBoardTitle: "Tableau des travaux",
      skillsLabel: "Competences & services",
  ...
  mfe: {
    ...
    jobForm: {
      ...
      urgentTitle: "Mo bizin led zordi",
      urgentDesc: "Mise an kontak urzan pou zordi mem.",
      plannedTitle: "Mo pe planifye",
      plannedDesc: "Poste ek les bann artizan verifye reponn.",
      describeLabel: "Dekrir problem-la dan ou prop mo",
      describePlaceholder: "Robine lakwizinn pe koule, kouran pe sote, laport bloke...",
      tradeLabel: "Metie - tap pou sanze",
      ...
      locDenied: "Pozisyon refize. Pa gagn traka, swazir landrwa pli pre.",
      whatsappLabel: "Nimero WhatsApp",
      privacy: "Ou nimero zame montre direk. Bann artizan kontak ou zis via lapp ou enn lien protze.",
      addPhoto: "Azout enn foto",
      photoHint: "Opsionel, imaz mwins ki 5 Mo",
      errUrgency: "Swazir kan ou bizin led.",
      errDescription: "Azout omwin 10 karakter pou ki bann artizan konpran travay-la.",
      errDistrict: "Swazir landrwa pli pre.",
      errPhone: "Met enn nimero WhatsApp Morisien valab.",
      errPhotoType: "Silvouple swazir enn fisye imaz.",
      errPhotoSize: "Foto tro gro. Swazir enn imaz mwins ki 5 Mo.",
      errPost: "Demann pa finn kapav poste.",
      errFailed: "Demann pa finn marse. Reesey.",
      back: "Retour",
      continue: "Kontinye",
      submitUrgent: "Trouv artizan aster",
      submitPlanned: "Poste mo demann",
      reqPrefix: "Demann",
      confTitle: "Ou demann an liyn",
      confNotifying: (n: number, d: string) => `Pe averti ${n} artizan anrezistre pou ${d}`,
      confTargeted: "artizan sible",
      confResponse: "tan repons mwayen",
      confAccept: "Nou pou avoy ou enn mesaz kan enn artizan aksepte",
    ...
    dashboard: {
      ...
      claimedJobsDesc: "Travay ki ou finn aksepte. Libere si ou pa kapav fer li.",
      targetedLeadsTitle: "Demann sible",
      jobBoardTitle: "Tablo travay",
      skillsLabel: "Konpetans & servis",
      workingHoursLabel: "Lertan travay",
      portfolioLabel: "Portfolio",
      accountStatusLabel: "Statiou kont",
